                ...
                <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === "ios" ? "padding" : "height"}>
                    <ScrollView contentContainerStyle={{ flexGrow: 1, justifyContent: "space-between" }} keyboardShouldPersistTaps="handled">
                        ...
                        <View className="items-center my-8">
                            <ImagePickerButton imageUri={image} onPress={pickImage} />
                        ...
                        <View className="gap-y-4">
                            <InputField placeholder="Пошта" keyboardType="email-address" textContentType="emailAddress" autoCapitalize="none" />
                            <PasswordField placeholder="Пароль" value={password} onChangeText={setPassword} />
                            <PasswordField placeholder="Підтвердьте пароль" value={confirmPassword} onChangeText={setConfirmPassword} />
                        </View>
